...
time_imp = {
            'descent': sol_case.get_val('traj.phase1.timeseries.time')}#'ascent': sol_case.get_val('traj.phase0.timeseries.time'),

time_exp = {
            'descent': sim_case.get_val('traj.phase1.timeseries.time')}#'ascent': sim_case.get_val('traj.phase0.timeseries.time'),

r_imp = {
         'descent': sol_case.get_val('traj.phase1.timeseries.states:x')}#'ascent': sol_case.get_val('traj.phase0.timeseries.states:x'),

r_exp = {
         'descent': sim_case.get_val('traj.phase1.timeseries.states:x')}#'ascent': sim_case.get_val('traj.phase0.timeseries.states:x'),

h_imp = {
         'descent': sol_case.get_val('traj.phase1.timeseries.states:y')}#'ascent': sol_case.get_val('traj.phase0.timeseries.states:y'),

h_exp = {
         'descent': sim_case.get_val('traj.phase1.timeseries.states:y')}#'ascent': sim_case.get_val('traj.phase0.timeseries.states:y'),
...
for i, state in enumerate(states):
    x_imp = {
             'descent': sol_case.get_val(f'traj.phase1.timeseries.{state}')} #'ascent': sol_case.get_val(f'traj.phase0.timeseries.{state}'),

    x_exp = {
             'descent': sim_case.get_val(f'traj.phase1.timeseries.{state}')} #'ascent': sim_case.get_val(f'traj.phase0.timeseries.{state}'),
