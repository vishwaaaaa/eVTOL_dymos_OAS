...
from evtol_dynamics_comp_climb import Dynamics 
from evtol_dynamics_comp_cruise_new import eVTOL2DODE
...
#####################################################################
    phase1 = dm.Phase(transcription=dm.GaussLobatto(num_segments=5, order=3, solve_segments=False,
                                                   compressed=False),
                     ode_class=eVTOL2DODE,
                     ode_init_kwargs={'input_dict': input_dict_d, 'OAS_surface_1':surf_dict, 'OAS_surface_2':surf_dict2})  ##the vectorized dynamics
    ...
    #phase1.connect('traj.phases.phase1.vx','vx')
